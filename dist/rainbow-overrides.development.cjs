...
const getOverrides = async () => {
    const overrides = {};
    const overrideFiles = glob__default['default'].sync('tokens/**/*.json');
    for (const overrideFile of overrideFiles) {
        const rawOverride = JSON.parse(await fs.promises.readFile(overrideFile, 'utf-8'));
        /**
...
const write = async () => {
     ...
     */
    await fs.promises.writeFile('src/data/rainbow-overrides.json', serialized);
};
...
exports.OFFLINE_TOKEN_OVERRIDES = rainbowOverrides;
exports.defaultOverrides = defaultOverrides;
exports.getOverrides = getOverrides;
exports.write = write;
//# sourceMappingURL=rainbow-overrides.development.cjs.map
